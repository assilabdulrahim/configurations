...
const TIERS = [
  ...
  ['coder', 'moonshotai/kimi-k2.7-code', 262144],
  ['python-dev', 'moonshotai/kimi-k2.7-code', 262144],
  ['dotnet-dev', 'moonshotai/kimi-k2.7-code', 262144],
  ['speed-coder', 'moonshotai/kimi-k2.7-code-highspeed', 262144],
  ['doc-writer', 'opencode/ling-3.0-flash-fin-free', 262144],
  ['deep-thinker', 'moonshotai/kimi-k3', 1048576],
  ['architect', 'moonshotai/kimi-k3', 1048576],
  ['cloud-architect', 'moonshotai/kimi-k3', 1048576],
  ['wide-coder', 'moonshotai/kimi-k3', 1048576],
  ...
  ['tester', 'deepseek/deepseek-flash', 1000000],
